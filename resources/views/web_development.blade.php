...
@section('content')
    ...
    <section class="slider-area">
        ...
        <div style="display: flex;justify-content: flex-start;align-items: center;" class="bg-overlay">
            ...
            <h1 class="container res-con" style="color: #FFFFFF;font-family: 'Poppins';text-align: left;max-width: 50%;padding: 0 0 0 35px;margin: 0;">
            
                <span class="res-text" style="font-size: 60px;">Grow more by <br> outsourcing your <br> Resume Writing <br> work to us!</span>
                <br>
                <a style="padding: 13px 18px;line-height: 1.4;border-radius: 5px;font-weight: 400;font-size: 18px;display: inline-block;margin-top: 30px;" class="btn anim-btn2 anim-btn3 rounded-pill scroll res-btn" tabindex="0">Read More <span></span><span></span><span></span><span></span></a>
    ...
    <style>
        ...
        .slider-area .bg-overlay
        {
            background-image: url("creative-startup/img/Group 1278.png") !important;
        }
