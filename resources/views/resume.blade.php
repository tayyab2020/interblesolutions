...
@section('content')
        ...
        <div class="row">
            <div class="col-12 stats-heading-area text-center">
                <div class="res-font" style="display: flex;justify-content: center;align-items: center;margin-top: 60px;font-size: 40px;font-weight: 700;font-family: 'Poppins';">
                    ...
                    <span style="color: #0A433E;">HOW</span> <span style="color: #0A433E;margin-left: 10px;">IT</span> <span style="color: #00CFBE;margin-left: 10px;">WORKS?</span>
                </div>
            </div>
        </div>
    ...
    <style>
        ...
        .slider-area .bg-overlay
        {
            background-image: url("creative-startup/img/Group 1222.png") !important;
        }
